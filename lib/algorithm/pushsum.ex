defmodule Gossip.Pushsum do
  ...
  @moduledoc """
  This module contains methods that set off the pushsum algorithm and also defines a tracker to count the number of nodes that have converged.
  """
  require Logger
  ...
  """
  def init_pushsum(selected_topology, num) do
    topology =
    ...
    for i <- 1..n do
      ...
      spawn(fn ->
        Gossip.PushSumActor.start_link(i, peers)
      end)
    end
    ...
    #Initiate the pushsum algorithm.
    pushsum_init(n)
